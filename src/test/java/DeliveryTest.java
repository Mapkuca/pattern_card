...
public class DeliveryTest {
    ...
    @Test
    void firstFormCorrect() {
        $("[data-test-id='city'] input").setValue(DataGenerator.generateCity());
        String date = getDateFormat(DataGenerator.generateDate());
    ...
    @Test
    void firstFormTestingAgain() {
        $("[data-test-id='city'] input").setValue(DataGenerator.generateCity());
        LocalDate oneDate = DataGenerator.generateDate();
        String date = getDateFormat(oneDate);
        String secondDate = getDateFormat(oneDate.plusDays(3));
        SelenideElement data = $("[data-test-id='date'] input");
